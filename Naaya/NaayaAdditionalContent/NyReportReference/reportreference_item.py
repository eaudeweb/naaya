...
class reportreference_item(Implicit, NyProperties):
    """ """
    ...
    def __init__(self, title, description, coverage, keywords, sortorder,
        releasedate, lang, reference, ref_links):
        """
        Constructor.
        """
    ...
    def save_references(self, ref_links):
        """
        Save references
        """
    ...
    def save_properties(self, title, description, coverage, keywords, sortorder,
        ...
        self._setLocalPropValue('reference',    lang, reference)
