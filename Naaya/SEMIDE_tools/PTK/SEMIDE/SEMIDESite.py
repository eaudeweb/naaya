...
class SEMIDESite(NySite, ProfileMeta, SemideVersions, export_pdf, SemideZip):
    ...
    def loadDefaultData(self):
        ...
        #Localiser messages
        for loc_lang in ['en', 'fr', 'ar']:
            loc_file = self.futRead(join(SEMIDE_PRODUCT_PATH, 'skel', 'others', '%s.po' % loc_lang), 'r')
            self.admin_importmessages(lang='%s' % loc_lang, file=loc_file)
