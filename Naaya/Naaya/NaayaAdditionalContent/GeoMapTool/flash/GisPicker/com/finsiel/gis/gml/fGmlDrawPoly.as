...
/* Class: com.finsiel.gis.gml.fGmlDrawPoly
   ...
   Draw a group of polygons into a specific container
...
class com.finsiel.gis.gml.fGmlDrawPoly {
	...
	*/
	public function fGmlDrawPoly(d_array:Array, d_container:MovieClip, myMB, _s_arr:Array) {
	...
	private function draw_now(p:Object, id:Number) {
		...
		var ds = new fGmlStylePoly(d_map,_myMB);
