// CHM2UninsDlg.cpp : implementation file
//
...
CCHM2UninsDlg::CCHM2UninsDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCHM2UninsDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCHM2UninsDlg)
...
void CCHM2UninsDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCHM2UninsDlg)
	DDX_Control(pDX, IDC_UNINSTALL_SUMMARY_EDIT, m_edtSummary);
	DDX_Control(pDX, IDC_UNINSTALL_PROGRESS, m_prgUninstall);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CCHM2UninsDlg, CDialog)
	//{{AFX_MSG_MAP(CCHM2UninsDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_CTLCOLOR()
...
/////////////////////////////////////////////////////////////////////////////
// CCHM2UninsDlg message handlers

BOOL CCHM2UninsDlg::OnInitDialog()
{
...
void CCHM2UninsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CCHM2UninsDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIcon;
}

void CCHM2UninsDlg::OnOK() 
{
	if (!m_bUninstallOK)
	{
		// PERFORM UNINSTALL
...
HBRUSH CCHM2UninsDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
void CCHM2UninsDlg::UpdateSummary(CString strText)
{
	CString strBuffer;
...
BOOL CCHM2UninsDlg::StopUninstallServices(CString& strError)
{
...
BOOL CCHM2UninsDlg::DeleteShortcuts(CString& strError)
{
	CUninsToolz toolz;
...
BOOL CCHM2UninsDlg::BackupFiles(CString& strError)
{
	CUninsToolz toolz;
...
BOOL CCHM2UninsDlg::DeleteNecessaryFiles(CString& strError)
{
	CUninsToolz toolz;
...
BOOL CCHM2UninsDlg::DeleteRegistry(CString& strError)
{
	CUninsToolz toolz;
