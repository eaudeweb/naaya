...
DEFAULT_SCHEMA['sdo_training_city'] = dict(sortorder=13, widget_type='String',
                label='Training city', property_type='Sdo extra property')
DEFAULT_SCHEMA['sdo_training_country'] = dict(sortorder=14, widget_type='Select',
                label='Country',list_id='countries', property_type='Sdo extra property')
DEFAULT_SCHEMA['sdo_start_date'] = dict(sortorder=15, widget_type='Date',
                label='Start date', property_type='Sdo extra property')
DEFAULT_SCHEMA['sdo_frequency'] = dict(sortorder=16, widget_type='Select',
                label='Frequency',list_id='sdo_frequency', property_type='Sdo extra property')
DEFAULT_SCHEMA['sdo_duration'] = dict(sortorder=17, widget_type='Select',
