...
/* Class: com.finsiel.gis.gml.fGmlDrawPoly

   Draw a group of raster

   Coordinate transformation will be applied from poly coordinates to container coordinates
...
*/
class com.finsiel.gis.gml.fGmlDrawRaster {
	//dispatchers
	...
	*/
	public function fGmlDrawRaster(d_array:Array, d_container:MovieClip, myMB, _s_arr:Array) {
	...
	private function draw_now(p:Object, id:Number) {
		...
		var ds = new fGmlStyleRaster(d_map,_myMB);
