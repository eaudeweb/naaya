...
DEFAULT_SCHEMA = {
    'youtube_id': dict(
        ...
        help_text="Tip: you can paste the youtube video URL, too"),
    'iframe_width': dict(sortorder=110, widget_type='String',
                         label='Video width'),
    'iframe_height': dict(sortorder=120, widget_type='String',
                          label='Video height'),
    'captions': {'sortorder': 130, 'widget_type': 'Checkbox',
                 'data_type': 'int', 'label': 'Show captions in this language',
...
def addNyYoutube(self, id='', REQUEST=None, contributor=None, **kwargs):
    ...
    if REQUEST is not None:
        ...
        if (l_referer == 'youtube_manage_add' or
                l_referer.find('youtube_manage_add') != -1):
