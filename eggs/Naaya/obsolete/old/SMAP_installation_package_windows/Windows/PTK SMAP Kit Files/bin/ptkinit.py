...
from Products.SMAP.SMAPSite import SMAPSite, manage_addSMAPSite
...
class PortalInit:
    ...
    def create_portal(self):
        ...
        try:
            ...
            add_error = manage_addSMAPSite(self.root, id='smap', lang='en')
        except Exception, error:
...
if __name__ == '__main__':
    ...
    SMAPSite.gl_get_selected_language = gl_get_selected_language
