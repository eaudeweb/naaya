...
class ContentType:
    ...
    def setPicture(self, p_picture):
        """ set the corresponding picture for this ContentType """
        if p_picture != '':
...
class DocContentTypes:
    ...
    def getContentTypeTitle(self, id):
        """ Get title """
        try:
            if self.__contenttype_dictionary.has_key(id):
                return self.__contenttype_dictionary[id].title
            else:
                return self.__contenttype_dictionary['undefined'].title
        except: return ''
    ...
    def getContentTypePicture(self, id):
        ...
        try:
            if self.__contenttype_dictionary.has_key(id):
                return self.__contenttype_dictionary[id].picture
            else:
                return self.__contenttype_dictionary['undefined'].picture
        except: return None
