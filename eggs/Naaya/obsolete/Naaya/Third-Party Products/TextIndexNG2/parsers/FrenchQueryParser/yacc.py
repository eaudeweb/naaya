...
# __file__ may potentially be relative - make it reliable.
...
def lr_write_tables(modulename=tab_module):
    filename = os.path.join(this_dir, modulename + ".py")
    try:
        f = open(filename,"w")
