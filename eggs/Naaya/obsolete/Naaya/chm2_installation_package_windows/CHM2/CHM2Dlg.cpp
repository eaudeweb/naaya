// CHM2Dlg.cpp : implementation file
//
...
CCHM2Dlg::CCHM2Dlg(CWnd* pParent /*=NULL*/)
	: CNewWizDialog(CCHM2Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCHM2Dlg)
...
void CCHM2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCHM2Dlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CCHM2Dlg, CNewWizDialog)
	//{{AFX_MSG_MAP(CCHM2Dlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CCHM2Dlg message handlers

BOOL CCHM2Dlg::OnInitDialog()
{
...
HCURSOR CCHM2Dlg::OnQueryDragIcon()
{
