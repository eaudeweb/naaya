...
try:
    from naaya.content.file.file_item import addNyFile, manage_addNyFile_html
...
from Products.NaayaContent.NyCHMReportComment.NyCHMReportComment     import addNyCHMReportComment, chm_reportcomment_add_html, manage_addNyCHMReportComment_html
from Products.NaayaContent.NyCHMReportComment.NyCHMReportComment     import METATYPE_OBJECT as METATYPE_NYCHMREPORTCOMMENT
...
config = {
        ...
        'module': 'NyReportQuestionnaire',
        'package_path': os.path.abspath(os.path.dirname(__file__)),
        'meta_type': 'Naaya Report Questionnaire',
        'label': 'Report Questionnaire',
        'permission': 'Naaya - Add Naaya Report Questionnaire objects',
        'forms': ['reportquestionnaire_add', 'reportquestionnaire_edit', 'reportquestionnaire_index'],
        'add_form': 'reportquestionnaire_add_html',
        'description': 'This is Naaya Report Questionnaire type.',
        'properties': PROPERTIES_OBJECT,
        'default_schema': None,
        'schema_name': '',
        'import_string': 'importNyReportQuestionnaire',
        '_module': sys.modules[__name__],
        'additional_style': None,
        'icon': os.path.join(os.path.dirname(__file__), 'www', 'NyReportQuestionnaire.gif'),
        '_misc': {
                'NyReportQuestionnaire.gif': ImageFile('www/NyReportQuestionnaire.gif', globals()),
                'NyReportQuestionnaire_marked.gif': ImageFile('www/NyReportQuestionnaire_marked.gif', globals()),
            },
    }
...
class NyReportQuestionnaire(NyAttributes, reportquestionnaire_item, NyContainer, NyCheckControl):
    """ """
    ...
    meta_types = ({'name': METATYPE_NYFILE, 'action': 'manage_addNyFile_html'},
                  ...
                  {'name': METATYPE_NYCHMREPORTCOMMENT, 'action': 'manage_addNyCHMReportComment_html'})
    ...
    security.declareProtected(PERMISSION_EDIT_OBJECTS, 'addNyCHMReportComment')
    addNyCHMReportComment = addNyCHMReportComment
    security.declareProtected(PERMISSION_EDIT_OBJECTS, 'chm_reportcomment_add_html')
    chm_reportcomment_add_html = chm_reportcomment_add_html
...
#            return output
    ...
    def getAllComments(self):    return self.objectValues(METATYPE_NYCHMREPORTCOMMENT)
