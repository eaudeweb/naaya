...
class NyDocumentFunctionalTestCase(NaayaFunctionalTestCase):
    ...
    def test_add(self):
        ...
        form['title:utf8:string'] = 'test_doc'
        form['description:utf8:string'] = 'test_doc_description'
        form['coverage:utf8:string'] = 'test_doc_coverage'
        form['keywords:utf8:string'] = 'keyw1, keyw2'
        form['body:utf8:string'] = 'test_doc_body'
    ...
    def test_edit(self):
        ...
        self.assertEqual(form['title:utf8:string'], 'My document')

        form['title:utf8:string'] = 'new_doc_title'
...
class NyDocumentVersioningFunctionalTestCase(NaayaFunctionalTestCase):
    ...
    def test_edit_version(self):
        ...
        form = self.browser.get_form('frmEdit')
        form['title:utf8:string'] = 'ver_doc_newtitle'
        self.browser.clicked(form, self.browser.get_form_field(form, 'title:utf8:string'))
        self.browser.submit()
    ...
    def test_save_changes_version(self):
        ...
        form = self.browser.get_form('frmEdit')
        form['title:utf8:string'] = 'ver_doc_version'
        self.browser.clicked(form, self.browser.get_form_field(form, 'title:utf8:string'))
        self.browser.submit()

        form = self.browser.get_form('frmEdit')
        self.assertEqual(form['title:utf8:string'], 'ver_doc_version')
