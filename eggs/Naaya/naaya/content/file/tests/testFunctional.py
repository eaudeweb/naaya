...
class NyFileFunctionalTestCase(NaayaFunctionalTestCase):
    ...
    def test_add(self):
        ...
        html = self.browser.get_html()
        self.assertTrue(re.search(r'<h1>.*test_create_file.*</h1>', html, re.DOTALL))
        self.assertTrue('test_file_description' in html)
        self.assertTrue('test_file_coverage' in html)
    ...
    def test_edit(self):
        ...
        self.assertEqual(self.portal.myfolder.myfile.title, 'new_file_title')
        self.assertEqual(self.portal.myfolder.myfile.getLocalProperty('title', 'fr'), 'french_title')
