# This script will create default EMWIS site
...
from Products.SEMIDE.SEMIDESite import SEMIDESite, manage_addSEMIDESite
...
class PortalInit:
    ...
    def create_portal(self):
        ...
        try:
            ...
            add_error = manage_addSEMIDESite(self.root, id='portal', lang='en')
        except Exception, error:
            ...
            if add_error is not None:
                ...
                try:
                    ...
                    #main topics
                    portal.getPropertiesTool().manageMainTopics(maintopics=['about', 'sponsors', 'Context', 'Institutions', 'documents', 'Training', 'RD', 'Data', 'Legislation', 'topics', 'Links', 'Who'])
                    #left portlets
                    portal.admin_leftportlets(portlets=['portlet_maincategories', 'portlet_left_logo'])
                    #HelpDeskAgent
                    portal.HelpDesk.mail_server_name = '@@PORTAL_MAILSERVERNAME@@'
                    portal.HelpDesk.mail_server_port = '@@PORTAL_MAILSERVERPORT@@'
                    portal.HelpDesk.mail_from_address = '@@PORTAL_DEFAULTFROMADDRESS@@'
                except Exception, error:
...
if __name__ == '__main__':
    ...
    SEMIDESite.gl_get_selected_language = gl_get_selected_language
