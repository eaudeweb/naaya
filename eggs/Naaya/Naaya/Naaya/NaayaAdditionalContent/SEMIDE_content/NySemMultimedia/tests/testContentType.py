...
from Products.NaayaContent.NySemMultimedia.NySemMultimedia import addNySemMultimedia
...
class NaayaContentTestCase(NaayaTestCase.NaayaTestCase):
    ...
    def test_main(self):
        """ Add, Find, Edit and Delete Naaya Semide Multimedia """
        addNySemMultimedia(self._portal().info, id='doc1', title='doc1', lang='en', submitted=1, source="Eau de Web")
        addNySemMultimedia(self._portal().info, id='doc1_fr', title='doc1_fr', lang='fr', submitted=1, source="Eau de Web")
        
        docs = self._portal().getCatalogedObjectsCheckView(meta_type=['Naaya Semide Multimedia'])
        ...
        brains = self._portal().getCatalogedObjectsCheckView(meta_type=['Naaya Semide Multimedia'])
