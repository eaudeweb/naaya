...
OBJECT_FORMS = ['reportchapter_add', 'reportchapter_edit', 'reportchapter_index']
...
def addNyReportChapter(self, id='', title='', description='', coverage='', keywords='',
    ...
    if not len(r):
        ...
        #create object
        ob = NyReportChapter(id, title, description, coverage, keywords, sortorder, contributor, releasedate, lang)
...
class NyReportChapter(NyAttributes, reportchapter_item, NyContainer, NyEpozToolbox, NyCheckControl):
    """ """
    ...
    def manage_options(self):
        """ """
        l_options = (NyContainer.manage_options[0],) + reportchapter_item.manage_options
    ...
    def __init__(self, id, title, description, coverage, keywords, sortorder, contributor, releasedate, lang):
        """ """
        self.id = id
        reportchapter_item.__dict__['__init__'](self,title, description, coverage, keywords, sortorder, releasedate, lang)
    ...
    def startVersion(self, REQUEST=None):
        ...
        self.version = reportchapter_item(self.title, self.description, self.coverage,
