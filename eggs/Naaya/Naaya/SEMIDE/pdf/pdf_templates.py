...
class pdf_templates:
    ...
    def _generate_country_object(self, p_obj, lang):
        ...
        #NFP
        l_res = []
        l_nfp_label = p_obj.nfp_label
        l_nfp_url = self.convertToFullURL(p_obj.nfp_url)
