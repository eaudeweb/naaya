...
class TestNyRoleManager(NaayaFunctionalTestCase):
    ...
    def test_local_roles_add_remove_raw(self):
        ...
        self.assertTrue('date' in additional_info[0])
        ...
        self.assertTrue('date' in additional_info[1])
