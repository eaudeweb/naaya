...
TAG_MAPPING = {
                   ...
                   'security/role/permission': {'rename': 'permissions',
                                                'type': 'list'},
                   'pluggablecontenttypes/pluggablecontenttype': \
                   {'rename': 'pluggablecontenttypes', 'type': 'list'},
                   'properties/language': {'rename': 'languages',
                                           'type': 'list'},
                   'properties/contenttype': {'rename': 'contenttypes',
                                              'type': 'list'},
                   'layout/skin': {'rename': 'skins', 'type': 'list'},
                   'layout/skin/template': {'rename': 'templates',
                                            'type': 'list'},
                   ...
                   'layout/skin/scheme/style': {'rename': 'styles',
                                                'type': 'list'},
                   'layout/skin/scheme/image': {'rename': 'images',
                                                'type': 'list'},
                   'syndication/namespace': {'rename': 'namespaces',
                                             'type': 'list'},
                   'syndication/channeltype': {'rename': 'channeltypes',
                                               'type': 'list'},
                   'syndication/scriptchannel': {'rename': 'scriptchannels',
                                                 'type': 'list'},
                   'syndication/localchannel': {'rename': 'localchannels',
                                                'type': 'list'},
                   'syndication/remotechannel': {'rename': 'remotechannels',
                                                 'type': 'list'},
                   'portlets/portlet': {'rename': 'portlets', 'type': 'list'},
                   'portlets/linkslist': {'rename': 'linkslists',
                                          'type': 'list'},
                   'portlets/linkslist/link': {'rename': 'links',
                                               'type': 'list'},
                   ...
                   'portlets/reftree/property': {'rename': 'properties',
                                                 'type': 'dict'},
                   'emails/emailtemplate': {'rename': 'emailtemplates',
                                            'type': 'list'}
               }
