...
class NaayaContentTestCase(NaayaTestCase.NaayaTestCase):
    ...
    def test_main(self):
        ...
        #add NyBlog
        addNyBlogEntry(self._portal().info, id='blog1', title='blog1', lang='en', submitted=1)
        addNyBlogEntry(self._portal().info, id='blog1_fr', title='blog1_fr', lang='fr', submitted=1)
