...
class ZopeOAIServer(zOAIRepository, Navigation):
    ...
    all_meta_types = ({'name': ZCatalogHarvester.meta_type, 'action': '/manage_addProduct/ZOpenArchives/manage_addZCatalogHarvesterForm', 'product': ZCatalogHarvester.meta_type}, )
