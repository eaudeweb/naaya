...
def addNyPhoto(self, id='', title='', author='', source='', description='', sortorder='',
    file='', precondition='', content_type='', quality='', lang=None, discussion='', releasedate='', REQUEST=None):
    """
    ...
    #create object
    ob = NyPhoto(id, title, author, source, description, sortorder, precondition, content_type, quality,
...
class NyPhoto(NyAttributes, LocalPropertyManager, NyItem, NyFSImage):
    ...
    icon = 'misc_/SEMIDEPhotoArchive/NyPhoto.gif'
    icon_marked = 'misc_/SEMIDEPhotoArchive/NyPhoto_marked.gif'
    ...
    def manageProperties(self, title='', author='', source='', description='',
        sortorder='', approved='', content_type='', quality='', releasedate='', discussion='', REQUEST=None):
        """ """
        if self.wl_isLocked():
